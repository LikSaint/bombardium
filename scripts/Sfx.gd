...
## without cutting each other off. Music (separate, planned later) will get
## its own volume/key so the two can be mixed independently.
...
const SOUNDS := {
	...
	"menu_move": preload("res://assets/sfx/menu_move.wav"),
	"menu_confirm": preload("res://assets/sfx/menu_confirm.wav"),
	"menu_back": preload("res://assets/sfx/menu_back.wav"),
	"player_join": preload("res://assets/sfx/player_join.wav"),
	"bot_toggle": preload("res://assets/sfx/bot_toggle.wav"),
}
